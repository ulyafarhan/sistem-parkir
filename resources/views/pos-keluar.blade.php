...
window.onload = function() {
    ...
    function showSuccess(data) {
        statusAwal.classList.add('hidden'); errorContainer.classList.add('hidden');
    ...
    function showError(message, isProcessing = false) {
        statusAwal.classList.add('hidden'); successContainer.classList.add('hidden');
    ...
    function onScanSuccess(decodedText, decodedResult) {
        ...
        try {
            ...
            console.log("File scan, no camera to pause.");
        }
